xml_file = 'rmining.wordpress.2017-01-16.xml'

old_url = 'https?://www.rmining.net'
new_url = 'http://www.rmining.net'
...
local({
  if (!dir.exists(d <- '../rmining-blog/content/')) return()
